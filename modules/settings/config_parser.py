...
class DiscordConfig(ConfigSection):
    ...
    def to_model(self) -> settings_models.Discord:
        ...
        channel_name = self.get_value(key="ChannelName", default="jellycord")
...
class GeneralConfig(ConfigSection):
    ...
    def to_model(self) -> settings_models.General:
        refresh_seconds = self.get_value(key="RefreshSeconds", default=15)
        return settings_models.General(RefreshSeconds=refresh_seconds)
...
class Config:
    ...
    general: settings_models.General
    ...
    def __init__(self, config_path: str, **docker_kwargs):
        ...
        self.general = GeneralConfig(data=start.get_subsection_data(key="General")).to_model()
