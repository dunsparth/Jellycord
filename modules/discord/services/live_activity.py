...
class LiveActivityMonitor(BaseService):
    ...
    async def on_ready(self):
        ...
        if self.use_summary_message:
            ...
            # If the very last message in the channel is from Jellycord, use it
            ...
            # If the very last message in the channel is not from Jellycord, make a new one.
            if not summary_message:
                logging.info("Couldn't find old message, sending initial message...")
                embed = discord.Embed(title="Welcome to Jellycord!")
